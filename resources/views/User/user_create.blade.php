...
<div class="container">
  ...
  <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"><input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
    ...
    <label class="form-group">Matric Number:</label>
    <input type="number" class="form-control" placeholder="Matric Number" name="matric"><br><br>

    <label>Student Name:</label>
    <input type="text" class="form-control" placeholder="Student Name" name="student"><br><br>

    <label>E-mail:</label>
    <input type="text" class="form-control" placeholder="E-mail" name="email"><br><br>

    <label>Kulliyah:</label>
    <input type="text" class="form-control" placeholder="Kulliyah etc:KICT" name="kulliyah"><br><br>
